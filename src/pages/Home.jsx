...
const Home = () => {
    ...
    return (
        <div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "80px 80px 0 80px", background: "#f5f5f5", textAlign: "center", gap: "40px" }}>
                ...
                <img src="/hero.png" alt="hero" style={{ width: "442px" }} />
            </div>

            <div style={{ background: "linear-gradient(160deg, #632EE3 5.68%, #9F62F2 88.38%)", padding: "80px", display: "flex", flexDirection: "column", alignItems: "center", gap: "40px" }}>
                ...
                <div style={{ display: "flex", gap: "24px", justifyContent: "center", width: "100%" }}>
                    {[{ label: "Total Downloads", value: "29.6M", sub: "21% more than last month" }, { label: "Total Reviews", value: "906K", sub: "46% more than last month" }, { label: "Active Apps", value: "132+", sub: "31 more will Launch" }].map((stat) => (
                        <div key={stat.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", width: "342px", textAlign: "center", color: "white" }}>
                            <p style={{ fontSize: "16px", opacity: 0.8 }}>{stat.label}</p>
                            <p style={{ fontSize: "64px", fontWeight: "800", lineHeight: "72px" }}>{stat.value}</p>
            ...
            <div style={{ padding: "80px", display: "flex", flexDirection: "column", gap: "40px", alignItems: "center" }}>
